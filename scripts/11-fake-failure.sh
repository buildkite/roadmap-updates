...
echo "--- :docker: Pulling container image"
...
echo "  Waiting for rollout to finish: 0 of 3 updated replicas are available..."
echo "  Waiting for rollout to finish: 1 of 3 updated replicas are available..."
echo "  Waiting for rollout to finish: 2 of 3 updated replicas are available..."
sleep 1

echo "--- :rotating_light: Health check failed"
echo ""
...
echo "--- :rewind: Rolling back to v2.14.6"
