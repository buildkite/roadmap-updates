...
- 📖 [Pipeline Triggers docs](https://buildkite.com/docs/apis/webhooks/incoming/pipeline-triggers)
- 📝 [Agentic CI examples](https://buildkite.com/resources/blog/building-ai-powered-ci-workflows-three-practical-examples)
ANNOTATION
